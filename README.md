...
> **프로젝트 개발 중단 안내**
>
> 백준 온라인 저지(BOJ)의 서비스 종료 발표에 따라, 본 프로젝트의 개발도 중단됩니다.
>
> 24년 BJCORD 1.0이 발표되고 약 2년간의 기간동안 프로젝트를 유지보수 해 왔습니다.
> 최초의 BJCORD는 html, js로 이루어진 200줄 남짓의 프로젝트였습니다. 이후 wxt로
> 2.0 버전이 개발되면서 매주 540여명이 이용하는 프로젝트가 되었습니다.
> 
> 2년간 BJCORD를 이용해주신 분들, 기여해주신 분들 모두 감사드립니다. 저 역시
> 많은 것을 배워갈 수 있었습니다. BOJ가 돌아와 BJCORD도 부활하기를 기원합니다. 감사합니다.
>
> 5tarlight, karpitony (2024.5 ~ 2026.4)
